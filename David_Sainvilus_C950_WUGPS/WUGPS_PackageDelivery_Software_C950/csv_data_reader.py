...
# Read CSV files
with open('csv_data/package_data.csv') as csvfile:
    read_csv = csv.reader(csvfile, delimiter=',')

    hash_map = HashMap()  # Calls the Hashmap class to create an instance of HashMap class
    first_delivery = []  # list  of first truck delivery
    second_delivery = []  # list of second truck delivery
    final_delivery = []  # list of last truck delivery
    ...
    for row in read_csv:
        ...
        value = [package_id, address_location, address, city, state, zip, delivery, size,
